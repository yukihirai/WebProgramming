...
<br>
<div align ="center">ログインID　　　<input type ="text"style="width:250px;" name="login_id" required></div><br>
<br>
...
<br>
<div align ="center">ユーザ名　　　<input type ="text"style="width:250px;" name="name"required></div><br>
<br>
<div align ="center">生年月日　　　<input type ="date"style="width:250px;" name="birth_date"required></div><br>
<br>
<br>
